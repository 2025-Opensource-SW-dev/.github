...
1. **검색 성능:** Radix Tree는 $O(K)$ (K는 키의 길이)의 시간 복잡도로 데이터에 접근하며, 범위 검색에 최적화되어 있어 시계열 데이터 조회에 탁월한 성능을 발휘한다.
...
1. Synchronous vs Asynchronous Architecture | Three Dots Labs blog, 11월 29, 2025에 액세스, https://threedots.tech/episode/sync-vs-async/
2. Message Broker Pattern for Microservices Interservice Communication | Redis, 11월 29, 2025에 액세스, https://redis.io/solutions/message-broker-pattern-for-microservices-interservice-communication/
3. What to Choose for Your Synchronous and Asynchronous ... - Redis, 11월 29, 2025에 액세스, https://redis.io/blog/what-to-choose-for-your-synchronous-and-asynchronous-communication-needs-redis-streams-redis-pub-sub-kafka-etc-best-approaches-synchronous-asynchronous-communication/
4. RabbitMQ vs Kafka: Choosing the Right Messaging System for Your Needs - Intellisoft, 11월 29, 2025에 액세스, https://intellisoft.io/rabbitmq-vs-kafka-choosing-the-right-messaging-system-for-your-needs/
5. Google Cloud Pub/Sub vs Redis Streams: Pros and Cons, 11월 29, 2025에 액세스, https://risingwave.com/blog/google-cloud-pub-sub-vs-redis-streams-pros-and-cons/
6. Backpressure explained — the resisted flow of data through software | by Jay Phelps, 11월 29, 2025에 액세스, https://medium.com/@jayphelps/backpressure-explained-the-flow-of-data-through-software-2350b3e77ce7
7. Redis Streams :: Spring Data Redis, 11월 29, 2025에 액세스, https://docs.spring.io/spring-data/redis/reference/redis/redis-streams.html
8. How to use backpressure with Redis streams? - Stack Overflow, 11월 29, 2025에 액세스, https://stackoverflow.com/questions/56420506/how-to-use-backpressure-with-redis-streams
9. Stop confusing Redis Pub/Sub with Streams : r/softwarearchitecture - Reddit, 11월 29, 2025에 액세스, https://www.reddit.com/r/softwarearchitecture/comments/1nw3e1h/stop_confusing_redis_pubsub_with_streams/
10. Streams: a new general purpose data structure in Redis. - antirez, 11월 29, 2025에 액세스, https://antirez.com/news/114
11. What are the main differences between Redis/Valkey Pub/Sub and Streams?, 11월 29, 2025에 액세스, https://stackoverflow.com/questions/59540563/what-are-the-main-differences-between-redis-valkey-pub-sub-and-streams
12. Redis Pub/sub | Docs, 11월 29, 2025에 액세스, https://redis.io/docs/latest/develop/pubsub/
13. Redis vs Kafka: A comprehensive comparison for developers | DoubleCloud, 11월 29, 2025에 액세스, https://double.cloud/blog/posts/2024/02/redis-vs-kafka/
14. Redis Streams | Docs, 11월 29, 2025에 액세스, https://redis.io/docs/latest/develop/data-types/streams/
15. Understanding Streams in Redis and Kafka A Visual Guide, 11월 29, 2025에 액세스, https://redis.io/resources/understanding-streams-in-redis-and-kafka-ebook.pdf
16. Redis Stream with Go: From Queue Creation to Reliable Message Retries - Stackademic, 11월 29, 2025에 액세스, https://blog.stackademic.com/redis-stream-with-go-from-queue-creation-to-reliable-message-retries-65ad5ac71c0c
17. Data Structures - Redis, 11월 29, 2025에 액세스, https://redis.io/technology/data-structures/
18. Redis RAX radix tree - redisGate Intro, 11월 29, 2025에 액세스, https://redisgate.jp/redis/configuration/internal_rax.php
19. Redis streams as a pure data structure -
20. Understanding Redis Streams. Twitter | LinkedIn | YouTube |… | by Raphael De Lio - Medium, 11월 29, 2025에 액세스, https://medium.com/redis-with-raphael-de-lio/understanding-redis-streams-33aa96ca7206
21. XINFO GROUPS | Docs - Redis, 11월 29, 2025에 액세스, https://redis.io/docs/latest/commands/xinfo-groups/
22. Documentation: Streams - Valkey, 11월 29, 2025에 액세스, https://valkey.io/topics/streams-intro/
23. XAUTOCLAIM | Docs - Redis, 11월 29, 2025에 액세스, https://redis.io/docs/latest/commands/xautoclaim/
24. Architecture | Docs - Redis, 11월 29, 2025에 액세스, https://redis.io/docs/latest/integrate/redis-data-integration/architecture/
25. Difference between Redis Pub/sub vs Redis streams - GeeksforGeeks, 11월 29, 2025에 액세스, https://www.geeksforgeeks.org/system-design/difference-between-redis-pub-sub-vs-redis-streams/
26. Diagnosing latency issues | Docs - Redis, 11월 29, 2025에 액세스, https://redis.io/docs/latest/operate/oss_and_stack/management/optimization/latency/
27. Redis persistence | Docs, 11월 29, 2025에 액세스, https://redis.io/docs/latest/operate/oss_and_stack/management/persistence/
28. Asynchronous AOF fsync is taking too long (disk is busy?). Writing the AOF buffer without waiting for fsync to complete, this may slow down Redis - Codemia, 11월 29, 2025에 액세스, https://codemia.io/knowledge-hub/path/asynchronous_aof_fsync_is_taking_too_long_disk_is_busy_writing_the_aof_buffer_without_waiting_for_fsync_to_complete_this_may_slow_down_redis
29. How Redis Persistence Actually Works (And When It Fails) | by Sohail Saifi - Medium, 11월 29, 2025에 액세스, https://medium.com/@sohail_saifi/how-redis-persistence-actually-works-and-when-it-fails-c3715d11529f
30. Benchmarking Redis, Dragonfly, Kafka, MQTT, and RabbitMQ for High-Load Messaging | by M Mahdi Ramadhan, M. Si | DevOps.dev, 11월 29, 2025에 액세스, https://blog.devops.dev/benchmarking-redis-dragonfly-kafka-mqtt-and-rabbitmq-for-high-load-messaging-5a6ca8c2b853
31. RabbitMQ vs Kafka vs Redis - Logit.io, 11월 29, 2025에 액세스, https://logit.io/blog/post/rabbitmq-vs-kafka-vs-redis/
32. Apache Kafka vs. RabbitMQ: Differences & Comparison - GitHub, 11월 29, 2025에 액세스, https://github.com/AutoMQ/automq/wiki/Apache-Kafka-vs.-RabbitMQ:-Differences-&-Comparison
33. RabbitMQ vs Redis OSS - Difference Between Pub/Sub Messaging Systems - AWS, 11월 29, 2025에 액세스, https://aws.amazon.com/compare/the-difference-between-rabbitmq-and-redis/
34. Redis vs RabbitMQ - Key Differences - Airbyte, 11월 29, 2025에 액세스, https://airbyte.com/data-engineering-resources/redis-vs-rabbitmq
35. Pub/Sub - Redis, 11월 29, 2025에 액세스, https://redis.io/glossary/pub-sub/
36. Redis streams how to route messages - Stack Overflow, 11월 29, 2025에 액세스, https://stackoverflow.com/questions/74963840/redis-streams-how-to-route-messages
